...
<?php
	...
	function updateData($params) {
		...
		$sql = "Update `tablestable` set servestatus='" . $params["edit_status"]."', reservedate = '" . $params["edit_date"] . "', reservetime='" . $params["edit_time"] . "', reservename = '" . $params["edit_name"] . "', availability = '" . $params["edit_availability"] . "' WHERE tableno ='".$_POST["edit_id"]."'";
