		...
		<table id="data_grid" class="table table-condensed table-hover table-striped" width="60%" cellspacing="5" data-toggle="bootgrid">
			<thead>
				<tr>
					...
					<th data-column-id="servestatus">Serve</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<input type="hidden" value="0" name="edit_id" id="edit_id">
				  ...
				  <div class="form-group">
                    <label for="edit_ava" class="control-label">Availability:</label>
                    <input type="text" class="form-control" id="edit_ava" name="edit_ava"/>
                  </div>
         <!--Close/Save button-->
            </div>
            <div class="modal-footer">
