         <?php 
				...
				if(isset($_POST["add_to_cart"]))
				{
					...
					if($_POST['hidtabno']!=0 || $_POST['hidempid']!=0)
					{
						if($_POST['hidempid']==0)
						{
						$sqls="SELECT * from ordertable ORDER BY orderid";	
						$resulto=mysqli_query($conn,$sqls);
					...
					{	
						...
						$add="INSERT INTO ordertable (empid,amt,qty,tableno,foodcode,dishname)VALUES('$y','$_POST[hidden_price]','$_POST[quantity]','$_POST[hidtabno]','$_GET[id]','$_POST[hidden_name]')";	
						}
					}
						
						else{
						$add="INSERT INTO ordertable (empid,amt,qty,tableno,foodcode,dishname)VALUES('$_POST[hidempid]','$_POST[hidden_price]','$_POST[quantity]','$_POST[hidtabno]','$_GET[id]','$_POST[hidden_name]')";
						}
					...
					$upd="INSERT INTO ordertable (empid,amt,qty,tableno,foodcode,dishname)VALUES('$y','$_POST[hidden_price]','$_POST[quantity]','$t','$_GET[id]','$_POST[hidden_name]')";
