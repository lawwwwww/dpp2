...
<body>
    ...
    <section class="content" >
		...
		$sql="SELECT * from menutable ORDER BY foodcode ASC";	
					...
					<div class="sidenav" >
						<br/>
						<h2 style="margin-left:50px; margin-top:50px;">Order Details</h2>
				...
				$result=mysqli_query($conn,$sql);
					...
					{	while($row=mysqli_fetch_array($result))
						...
						<form method="post" action="payment1.php">
							<input type="submit" value="pay" name="add_pay" style="margin-left:50px;margin-top:20px;" class="btn btn-success"/>
