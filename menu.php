...
<body>
    ...
    <section class="content" >
		...
		$sql="SELECT * from menutable ORDER BY foodcode ASC";	
					...
					<div class="sidenav" >
						<br/>
						<h2 style="margin-left:27px; margin-top:50px;">Order Details</h2>
				...
				$resullpt=mysqli_query($conn,$sql);
					...
					{	while($row=mysqli_fetch_array($resullpt))
						{	
							...
							<td><h4>
							<a href="menu.php?action=delete&id=<?php echo $row["orderid"];?>&tableno=<?php echo $row["tableno"];?>" onclick="remove()">
						...
						<form method="post" action="payment1.php">
							<input type="submit" value="pay" name="add_pay" style="margin-left:30px;margin-top:20px;" class="btn btn-success"/>
