        ...
        <div class="row">
            <div class="col-xs-12">
				...
				<?php	
						...
						$th="UPDATE tablestable set reservedate=null,reservetime=null,reservename='',servestatus='yes',availability='no' where reservedate='$datee' and reservetime='$timee'";
						mysqli_query($conn,$th);
